...
const translations = {
  en: {
    ...
    heroLede: "Start with one complete sprite atlas. Edit every frame, compose any animation, and connect mouse or system events. Each project is a companion with a personality of its own.",
    ...
    frameDesc: "Preview individual frames, import or export PNGs, tune scale, X/Y offsets, and timing, then normalize everything back into the atlas.",
    frameOne: "Frame 01",
    scale: "Scale",
    normalize: "Normalize",
    ...
    multiDesc: "Every project keeps its own atlas, triggers, window position, and visibility, while multiple pets can share the desktop.",
  ...
  zh: {
    ...
    heroLede: "从一张完整图集出发，编辑每一帧、组合任意动作、绑定鼠标与系统事件。一个工程是一只桌宠，也是一套完整的性格。",
    ...
    frameDesc: "单帧预览、PNG 导入导出、相对缩放、X/Y 位移与时长调整，最后一键归一化回整张图集。",
    frameOne: "第 1 帧",
    scale: "缩放",
    normalize: "归一化",
    eventEngine: "事件引擎",
    ...
    multiDesc: "每个工程独立保存图集、触发规则、窗口位置与显示状态，并能同时出现在桌面。",
    openFormat: "开放格式",
